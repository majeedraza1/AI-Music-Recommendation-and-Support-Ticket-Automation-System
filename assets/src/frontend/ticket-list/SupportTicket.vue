    ...
    <div class="Support-ticket-wrapper">
        <div class="support-tickets-left-content">
            <div class="support-ticket-toggle" v-for="(filter, index) in filters" v-if="filter.options.length">
                <div>
                    <svg aria-hidden="true" focusable="false" data-prefix="fad" data-icon="list" role="img"
                         xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-list fa-w-16"
                ...
                <toggle :name="filter.name" :selected="index === 0">
                    <ul class="dropdown-content">
                        <li v-for="_option in filter.options">{{_option.label}}</li>
                    </ul>
                </toggle>
            </div>
            <div class="support-ticket-toggle">
                <div>
                    <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="cog" role="img"
                         xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-cog fa-w-16">
                        <path fill="currentColor"

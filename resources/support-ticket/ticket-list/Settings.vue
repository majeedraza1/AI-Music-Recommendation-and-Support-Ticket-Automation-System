...
import {iconContainer, shaplaButton, tab, tabs} from 'shapla-vue-components';
...
import ExtraFields from "../../support-ticket/settings/ExtraFields.vue";
  ...
  methods: {
    ...
    getSettingsFields() {
      axios.get(StackonetSupportTicket.restRoot + '/settings', {params: {user_options: true}}).then(response => {
        ...
        this.fields_label = data.fields_label;

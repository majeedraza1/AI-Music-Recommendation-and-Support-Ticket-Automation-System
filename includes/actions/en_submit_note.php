...
foreach ( $email_templates as $email ) :
	...
	if ( $wpscfunction->check_ticket_conditions( $conditions, $ticket_id ) ) :
		...
		$last_note       = $wpscfunction->get_last_note( $ticket_id );
		$email_addresses = array_diff( $email_addresses, array( $last_note['user_email'] ) );
		$email_addresses = apply_filters( 'support_ticket_notification_submit_note_email_addresses', $email_addresses, $email, $thread_id, $ticket_id );

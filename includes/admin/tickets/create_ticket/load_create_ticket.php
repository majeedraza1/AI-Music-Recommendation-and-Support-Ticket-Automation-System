    ...
    <div class="row wpsc_tl_action_bar"
        ...
        <div class="col-sm-12">
			...
			<?php if ( $current_user->ID ): ?>
                <button type="button" id="wpsc_load_ticket_list_btn" onclick="wpsc_get_ticket_list();"
    ...
    <div id="create_ticket_body" class="row"
        ...
        <form id="wpsc_frm_create_ticket" onsubmit="return wpsc_submit_ticket();" method="post">
                    ...
                    <div class="row create_ticket_fields_container">
                        <div class="col-md-6 captcha_container"
                            ...
                            <div style="width:25px;">
                                <input type="checkbox" onchange="get_captcha_code(this);" class="wpsc_checkbox"
                                       value="1">
                ...
                <div class="row create_ticket_fields_container">
                    <div class="col-sm-12" style="margin-bottom:10px; display:flex;">
                        ...
                        <div style="padding-top:3px;">
							<?php echo html_entity_decode( $wpsc_gdpr_html ) ?>
                        </div>
                    </div>
                </div>
				<?php
			...
			if ( $wpsc_terms_and_conditions ) { ?>
                ...
                <div class="row create_ticket_fields_container">
                    <div class="col-sm-6" style="margin-bottom:10px; display:flex;">
                        ...
                        <div style="padding-top:3px;">
							<?php
							echo html_entity_decode( $wpsc_terms_and_conditions_html );
							?>
                        </div>
                    </div>
                </div>
                ...
                <div class="row create_ticket_fields_container">
                    <div class="col-sm-6" style="margin-bottom:10px; display:flex;">
                        <div style="width:25px;">
                            ...
                            <input <?php echo $checked ?> type="checkbox" name="notify_owner" id="notify_owner"
                                                          value="1">
                        </div>
            ...
            <div class="row create_ticket_frm_submit">
                <button type="submit" id="wpsc_create_ticket_submit" class="btn"
                ...
                <button type="button" id="wpsc_create_ticket_reset" onclick="wpsc_get_create_ticket();" class="btn"
    ...
    <script type="text/javascript">
        ...
        function support_ticket_attachment_upload(id, name) {
            ...
            jQuery('#attachment_upload').on('change', function () {
                ...
                if (!flag && jQuery.inArray(file_extension, allowedExtension) > -1) {
                    flag = true;

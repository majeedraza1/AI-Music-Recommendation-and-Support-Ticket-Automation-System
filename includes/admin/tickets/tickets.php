...
?>
    ...
    <div class="bootstrap-iso">
        ...
        <div id="wpsc_tickets_container" class="row"
             style="border-color:<?php echo $general_appearance['wpsc_action_bar_color'] ?> !important;"></div>
        ...
        <div class="bootstrap-iso">
            <div class="row">
                <div id="wpsc_popup"
                    ...
                    <div id="wpsc_popup_title" class="row"
                         style="background-color:<?php echo $wpsc_appearance_modal_window['wpsc_header_bg_color'] ?> !important;color:<?php echo $wpsc_appearance_modal_window['wpsc_header_text_color'] ?> !important;">
                        <h3><?php _e( 'Modal Title', 'supportcandy' ); ?></h3></div>

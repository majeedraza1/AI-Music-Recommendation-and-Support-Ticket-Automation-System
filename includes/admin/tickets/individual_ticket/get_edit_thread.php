    ...
    <div class="row">
        <div class="col-md-12" style="text-align: right;">
            <button type="button" class="btn wpsc_popup_close"
                    ...
                    onclick="wpsc_modal_close_thread(<?php echo $tinymce_array ?>);"><?php _e( 'Close', 'supportcandy' ); ?></button>
            <button type="button" class="btn wpsc_popup_action"
                    ...
                    onclick="wpsc_set_edit_thread(<?php echo htmlentities( $ticket_id ) ?>);"><?php _e( 'Save Changes', 'supportcandy' ); ?></button>
        </div>
    </div>

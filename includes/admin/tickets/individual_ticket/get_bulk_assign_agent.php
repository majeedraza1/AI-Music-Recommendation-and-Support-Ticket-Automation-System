    ...
    <form id="frm_bulk_assigned_agents">
        <div id="assigned_agent">
            <div class="form-group wpsc_display_assign_agent ">
                <input class="form-control form-control wpsc_assign_agents ui-autocomplete-input" name="assigned_agents"
                       type="text" autocomplete="off" placeholder="<?php _e( 'Search agent ...', 'supportcandy' ) ?>"/>
...
?>
    ...
    <button type="button" class="btn wpsc_popup_action"
            ...
            onclick="wpsc_set_bulk_assign_agent();"><?php _e( 'Save', 'supportcandy' ); ?></button>

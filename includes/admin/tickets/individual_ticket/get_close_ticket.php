...
?>
    <form id="frm_close_ticket">
        ...
        <div class="form-group">
            <p><?php _e( 'Are you sure to close this ticket?', 'supportcandy' ); ?></p>
        </div>

        <input type="hidden" name="action" value="wpsc_tickets"/>
        <input type="hidden" name="setting_action" value="set_close_ticket"/>
...
?>
    <button type="button" class="btn wpsc_popup_close"
            ...
            onclick="wpsc_modal_close();"><?php _e( 'Cancel', 'supportcandy' ); ?></button>
    <button type="button" class="btn wpsc_popup_action"
            ...
            onclick="wpsc_set_close_ticket(<?php echo htmlentities( $ticket_id ) ?>);"><?php _e( 'Confirm', 'supportcandy' ); ?></button>
<?php

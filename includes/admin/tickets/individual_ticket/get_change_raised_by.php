...
?>
    <form id="frm_get_ticket_raised_by" method="post">
        <div class="row" style="padding-left:2px;">
            <div data-fieldtype="text" data-visibility=""
                 class="col-sm-6 visible wpsc_required form-group wpsc_form_field field">
                ...
                <input type="text" id="customer_name" class="form-control regi_user_autocomplete ui-autocomplete-input"
                       name="customer_name" autocomplete="off"
                       value="<?php echo htmlentities( stripcslashes( $customer_name ) ) ?>">
            </div>
            <div data-fieldtype="email" data-visibility=""
                 class="col-sm-6 visible wpsc_required form-group wpsc_form_field field">
                ...
                <input type="text" id="customer_email" class="form-control" name="customer_email" autocomplete="off"
...
?>
    ...
    <button type="button" class="btn wpsc_popup_action"
            ...
            onclick="wpsc_set_change_raised_by(<?php echo $ticket_id ?>);"><?php _e( 'Save', 'supportcandy' ); ?></button>
<?php
$footer = ob_get_clean();

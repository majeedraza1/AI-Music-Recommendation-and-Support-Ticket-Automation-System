        ...
        <div class="row">
            ...
            <div class="col-sm-4" style="">
                <select class="form-control" name="wpsc_tl_agent_orderby_order">
                    ...
                    <option <?php echo $agent_orderby_order == 'ASC' ? 'selected="selected"' : '' ?> value="ASC">ASC
                    </option>
                    <option <?php echo $agent_orderby_order == 'DESC' ? 'selected="selected"' : '' ?> value="DESC">
                        DESC
                    </option>
                </select>
            </div>
        ...
        <div class="row">
            <div class="col-sm-4" style="">
                <select class="form-control" name="agent_no_of_tickets">
                    ...
                    <option <?php echo $agent_no_of_tickets == '10' ? 'selected="selected"' : '' ?>
                            value="10"><?php _e( '10', 'supportcandy' ) ?></option>
                    <option <?php echo $agent_no_of_tickets == '20' ? 'selected="selected"' : '' ?>
                            value="20"><?php _e( '20', 'supportcandy' ) ?></option>
                    <option <?php echo $agent_no_of_tickets == '30' ? 'selected="selected"' : '' ?>
                            value="30"><?php _e( '30', 'supportcandy' ) ?></option>
                    <option <?php echo $agent_no_of_tickets == '40' ? 'selected="selected"' : '' ?>
                            value="40"><?php _e( '40', 'supportcandy' ) ?></option>
                    <option <?php echo $agent_no_of_tickets == '50' ? 'selected="selected"' : '' ?>
                            value="50"><?php _e( '50', 'supportcandy' ) ?></option>
                    <option <?php echo $agent_no_of_tickets == '100' ? 'selected="selected"' : '' ?>
                            value="100"><?php _e( '100', 'supportcandy' ) ?></option>
                    <option <?php echo $agent_no_of_tickets == '500' ? 'selected="selected"' : '' ?>
                            value="500"><?php _e( '500', 'supportcandy' ) ?></option>
                </select>
            </div>
        </div>
    </div>
        ...
        <div class="row">
			...
			foreach ( $statuses as $status ) :
                ...
                <div class="col-sm-4" style="margin-bottom:10px; display:flex;">
                    <div style="width:25px;"><input type="checkbox"
                                                    name="wpsc_tl_agent_unresolve_statuses[]" <?php echo $checked ?>
                                                    value="<?php echo $status->term_id ?>"/></div>
        ...
        <div class="row">
                ...
                <select class="form-control" name="wpsc_tl_customer_orderby">
					...
					foreach ( $orderby_fields as $field ) :
                        ...
                        <option <?php echo $selected ?>
                                value="<?php echo $field->slug ?>"><?php echo htmlentities( $label ) ?></option>
					<?php
					endforeach;
					?>
                </select>
            ...
            <div class="col-sm-4" style="">
                <select class="form-control" name="customer_orderby_order">
                    ...
                    <option <?php echo $customer_orderby_order == 'ASC' ? 'selected="selected"' : '' ?> value="ASC">
                        ASC
                    </option>
                    <option <?php echo $customer_orderby_order == 'DESC' ? 'selected="selected"' : '' ?> value="DESC">
                        DESC
                    </option>
                </select>
            </div>
        ...
        <div class="row">
            <div class="col-sm-4" style="">
                <select class="form-control" name="customer_no_of_tickets">
                    ...
                    <option <?php echo $customer_no_of_tickets == '10' ? 'selected="selected"' : '' ?>
                            value="10"><?php _e( '10', 'supportcandy' ) ?></option>
                    <option <?php echo $customer_no_of_tickets == '20' ? 'selected="selected"' : '' ?>
                            value="20"><?php _e( '20', 'supportcandy' ) ?></option>
                    <option <?php echo $customer_no_of_tickets == '30' ? 'selected="selected"' : '' ?>
                            value="30"><?php _e( '30', 'supportcandy' ) ?></option>
                    <option <?php echo $customer_no_of_tickets == '40' ? 'selected="selected"' : '' ?>
                            value="40"><?php _e( '40', 'supportcandy' ) ?></option>
                    <option <?php echo $customer_no_of_tickets == '50' ? 'selected="selected"' : '' ?>
                            value="50"><?php _e( '50', 'supportcandy' ) ?></option>
                    <option <?php echo $customer_no_of_tickets == '100' ? 'selected="selected"' : '' ?>
                            value="100"><?php _e( '100', 'supportcandy' ) ?></option>
                    <option <?php echo $customer_no_of_tickets == '500' ? 'selected="selected"' : '' ?>
                            value="500"><?php _e( '500', 'supportcandy' ) ?></option>
                </select>
            </div>
        </div>
    ...
    <div class="from-group">
        ...
        <div class="row">
			...
			foreach ( $statuses as $status ) :
                ...
                <div class="col-sm-4" style="margin-bottom:10px; display:flex;">
                    <div style="width:25px;"><input type="checkbox"
                                                    name="wpsc_tl_customer_unresolve_statuses[]" <?php echo $checked ?>
                                                    value="<?php echo $status->term_id ?>"/></div>
                    <div style="padding-top:3px;"><?php echo $status->name ?></div>
                </div>
			<?php

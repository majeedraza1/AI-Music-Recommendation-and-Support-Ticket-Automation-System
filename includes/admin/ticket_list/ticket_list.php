        ...
        <div class="row">
            <div class="col-sm-4 wpsc_setting_col1">
                <ul class="nav nav-pills nav-stacked wpsc_setting_pills">
                    <li id="wpsc_agent_ticket_list" role="presentation" class="active"><a
                                href="javascript:wpsc_get_agent_ticket_list();"><?php _e( 'Agent Ticket List', 'supportcandy' ); ?></a>
                    </li>
                    <li id="wpsc_customer_ticket_list" role="presentation"><a
                                href="javascript:wpsc_get_customer_ticket_list();"><?php _e( 'Customer Ticket List', 'supportcandy' ); ?></a>
                    </li>
                    <li id="wpsc_agent_ticket_filters" role="presentation"><a
                                href="javascript:wpsc_get_agent_ticket_filters();"><?php _e( 'Agent Ticket Filters', 'supportcandy' ); ?></a>
                    </li>

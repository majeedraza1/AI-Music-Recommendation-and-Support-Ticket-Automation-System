        ...
        <div class="row" style="margin-bottom:20px;">
            <ul class="nav nav-pills wpsc_setting_pills">
                ...
                <li id="wpsc_agentonly_fields" role="presentation"><a
                            href="javascript:wpsc_get_agentonly_fields();"><?php _e( 'Agent Only Fields', 'supportcandy' ); ?></a>
                </li>
				<?php do_action( 'wpsc_after_form_setting_pills' ); ?>
            </ul>
        </div>
        ...
        <div class="bootstrap-iso">
            <div class="row">
                <div id="wpsc_popup"
                    ...
                    <div id="wpsc_popup_title" class="row"><h3><?php _e( 'Modal Title', 'supportcandy' ); ?></h3></div>

...
<h4>
    ...
    <button style="margin-left:10px;" class="btn btn-success btn-sm" id="wpsc_add_new_form_field_btn"
            onclick="wpsc_get_add_form_field();"><?php _e( '+Add New', 'supportcandy' ); ?></button>
</h4>
	...
	<?php foreach ( $fields as $field ) :
        ...
        <li class="ui-state-default" data-id="<?php echo $field->term_id ?>">
            <div class="wpsc-flex-container" style="background-color:<?php echo $bg_color ?>;color:#fff;">
                ...
                <div class="wpsc-sortable-edit"
                     onclick="<?php echo $type != '0' ? 'wpsc_get_edit_form_field(' . $field->term_id . ');' : 'wpsc_get_edit_default_form_field(' . $field->term_id . ');' ?>">
                    <i class="fa fa-edit"></i></div>
                <div class="wpsc-sortable-delete" onclick="wpsc_delete_custom_field(<?php echo $field->term_id ?>);"><i

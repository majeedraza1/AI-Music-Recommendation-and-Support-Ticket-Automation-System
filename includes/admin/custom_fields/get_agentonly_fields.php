...
<h4>
    ...
    <button style="margin-left:10px;" class="btn btn-success btn-sm"
            onclick="wpsc_get_add_agentonly_field();"><?php _e( '+Add New', 'supportcandy' ); ?></button>
</h4>
	...
	<?php foreach ( $fields as $field ) :
        ...
        <li class="ui-state-default" data-id="<?php echo $field->term_id ?>">
            <div class="wpsc-flex-container" style="background-color:#1E90FF;color:#fff;">
                ...
                <div class="wpsc-sortable-edit" onclick="wpsc_get_edit_agentonly_field(<?php echo $field->term_id ?>);">

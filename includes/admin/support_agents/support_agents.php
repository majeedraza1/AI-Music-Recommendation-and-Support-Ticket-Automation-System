    ...
    <div class="bootstrap-iso">
        ...
        <div class="row" style="margin-bottom:20px;">
            <ul class="nav nav-pills wpsc_setting_pills">
                <li id="wpsc_support_agents" role="presentation" class="active"><a
                            href="javascript:wpsc_get_support_agents();"><?php _e( 'Support Agents', 'supportcandy' ); ?></a>
                </li>
                <li id="wpsc_settings_agent_roles" role="presentation"><a
                            href="javascript:wpsc_get_agent_roles();"><?php _e( 'Agent Roles', 'supportcandy' ); ?></a>
                </li>

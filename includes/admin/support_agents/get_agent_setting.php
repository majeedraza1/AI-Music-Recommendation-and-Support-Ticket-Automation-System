    ...
    <form id="wpsc_frm_agent_setting" method="post">
        <div class="form-group">
            <label class="label label-default"
                   style="font-size:15px;"><?php _e( 'Signature', 'supportcandy' ) ?></label>
        </div>
        <div class="form-group">
            <textarea class="form-control" name="wpsc_agent_signature"
                      id="wpsc_agent_signature"><?php echo html_entity_decode( $wpsc_agent_body ) ?></textarea>
        </div>
...
?>
    ...
    <button type="button" class="btn wpsc_popup_action"
            ...
            onclick="wpsc_set_agent_setting();"><?php _e( 'Save Settings', 'supportcandy' ); ?></button>
<?php
$footer = ob_get_clean();

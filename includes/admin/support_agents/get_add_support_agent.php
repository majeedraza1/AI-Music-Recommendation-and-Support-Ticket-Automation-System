...
?>
    <div class="form-group">
        ...
        <input id="wpsc_agent_name" class="form-control" placeholder="<?php _e( 'Search...', 'supportcandy' ); ?>"
               name="wpsc_priority_name" value=""/>
...
?>
    ...
    <button type="button" class="btn wpsc_popup_action"
            onclick="wpsc_set_add_support_agent();"><?php _e( 'Submit', 'supportcandy' ); ?></button>
<?php
$footer = ob_get_clean();

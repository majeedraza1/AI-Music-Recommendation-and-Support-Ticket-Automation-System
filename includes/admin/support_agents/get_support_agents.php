...
<h4>
    ...
    <button style="margin-left:10px;" class="btn btn-success btn-sm" id="wpsc_add_new_support_agent_btn"
            onclick="wpsc_get_add_support_agent();"><?php _e( '+Add New', 'supportcandy' ); ?></button>
</h4>
...
<table class="table table-striped table-hover">
	...
	<?php foreach ( $agents as $agent ) :
        ...
        <tr>
            ...
            <td>
                <div class="wpsc_flex">
                    <div onclick="wpsc_get_edit_support_agent(<?php echo $agent->term_id; ?>);" style="cursor:pointer;">
                        <i class="fa fa-edit"></i></div>
                    <div onclick="wpsc_delete_support_agent(<?php echo $agent->term_id; ?>);"
                         style="cursor:pointer; padding-left: 10px;"><i class="fa fa-trash"></i></div>
                </div>
            </td>
        </tr>
	<?php endforeach; ?>

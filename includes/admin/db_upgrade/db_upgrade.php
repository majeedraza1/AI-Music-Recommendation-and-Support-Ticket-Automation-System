	...
	if ( $addons_compatibility ) {
        ...
        <div class="bootstrap-iso">
            ...
            <div class="row" style="margin-top:20px;">
                <div id="wpsc_upgrade_dialog_container"
                    ...
                    <p class="help-block" style="font-size:15px;text-align:left;">Please upgrade the following add-ons
                        in order to make it compatible with SupportCandy v2.0</p>

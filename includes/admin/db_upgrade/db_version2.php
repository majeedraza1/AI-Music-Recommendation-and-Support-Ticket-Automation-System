...
<div class="bootstrap-iso">
    ...
    <div class="row" style="margin-top:20px;">
        <div id="wpsc_upgrade_dialog_container" class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2"
             style="background-color:#fff;text-align:center;padding-bottom:20px;">
            <h3>Database Upgrade Required</h3>
            <p class="help-block" style="font-size:15px">Database upgrade is required in your installation for
                SupportCandy (not related to database tables other than SupportCandy). This is mandatory process and you
                will not see ticket list until you complete this. This may take few minutes, please do not press "Back"
                or "Refresh" button until it finishes.</p>
            <button type="button" class="btn btn-sm btn-primary" onclick="wpsc_db_upgrade_version2()">Upgrade Now
            </button>
        </div>
    </div>

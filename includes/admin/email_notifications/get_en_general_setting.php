...
<form id="wpsc_frm_general_settings" method="post" action="javascript:wpsc_set_en_general_settings();">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="wpsc_en_from_name" id="wpsc_en_from_name"
               value="<?php echo get_option( 'wpsc_en_from_name', '' ); ?>"/>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="wpsc_en_from_email" id="wpsc_en_from_email"
               value="<?php echo get_option( 'wpsc_en_from_email', '' ); ?>"/>
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="wpsc_en_reply_to" id="wpsc_en_reply_to"
               value="<?php echo get_option( 'wpsc_en_reply_to', '' ); ?>"/>
    </div>
    ...
    <div class="form-group">
		...
		?>
        <textarea class="form-control" style="height:100px !important;" name="wpsc_en_ignore_emails"
                  id="wpsc_en_ignore_emails"><?php echo stripcslashes( implode( '\n', $ignore_emails ) ) ?></textarea>
    </div>

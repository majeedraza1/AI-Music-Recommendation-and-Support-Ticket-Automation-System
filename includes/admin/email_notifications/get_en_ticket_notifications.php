...
<h4>
    ...
    <button style="margin-left:10px;" class="btn btn-success btn-sm"
            onclick="wpsc_get_add_ticket_notification();"><?php _e( '+Add New', 'supportcandy' ); ?></button>
</h4>
...
<table class="table table-striped table-hover">
	...
	<?php foreach ( $email_templates as $email_template ) :
        ...
        <tr>
            ...
            <td>
                <div class="wpsc_flex">
                    <div onclick="wpsc_get_edit_ticket_notification(<?php echo $email_template->term_id; ?>);"
                         style="cursor:pointer;"><i class="fas fa-edit"></i></div>
                    <div onclick="wpsc_clone_ticket_notification(<?php echo $email_template->term_id; ?>);"
                         style="cursor:pointer; padding-left: 10px;"><i class="far fa-clone"></i></div>
                    <div onclick="wpsc_delete_ticket_notification(<?php echo $email_template->term_id; ?>);"
                         style="cursor:pointer; padding-left: 10px;"><i class="fas fa-trash"></i></div>
                </div>
            </td>
        </tr>
	<?php endforeach; ?>

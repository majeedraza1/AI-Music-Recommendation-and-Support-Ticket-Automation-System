...
<h4>
    ...
    <button style="margin-left:10px;" class="btn btn-success btn-sm"
            onclick="wpsc_get_add_priority();"><?php _e( '+Add New', 'supportcandy' ); ?></button>
</h4>
...
<ul class="wpsc-sortable">
	<?php foreach ( $priorities as $priority ) :
        ...
        <li class="ui-state-default" data-id="<?php echo $priority->term_id ?>">
            <div class="wpsc-flex-container"
                 style="background-color:<?php echo $backgound_color ?>;color:<?php echo $color ?>;">
                <div class="wpsc-sortable-handle"><i class="fa fa-bars"></i></div>
                <div class="wpsc-sortable-label"><?php echo $priority->name ?></div>
                <div class="wpsc-sortable-edit" onclick="wpsc_get_edit_priority(<?php echo $priority->term_id ?>);"><i
                            class="fa fa-edit"></i></div>
                <div class="wpsc-sortable-delete" onclick="wpsc_delete_priority(<?php echo $priority->term_id ?>);"><i

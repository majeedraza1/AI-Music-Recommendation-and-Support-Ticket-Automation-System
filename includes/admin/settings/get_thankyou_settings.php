...
<form id="wpsc_frm_thankyou_settings" method="post" action="javascript:wpsc_set_thankyou_settings();">
    ...
    <div class="form-group">
        ...
        <p class="help-block"><?php _e( "Text to show on thank you screen.", "wpsc" ); ?></p>
        <textarea class="form-control" name="wpsc_thankyou_html"
                  id="wpsc_thankyou_html"><?php echo htmlentities( $wpsc_thankyou_html ) ?></textarea>
    ...
    <div class="form-group">
        ...
        <p class="help-block"><?php _e( "Url to redirect in case you want to show your custom thank you page. Keep this empty to show above default thank you messege.", "wpsc" ); ?></p>
        <input type="text" class="form-control" name="wpsc_thankyou_url" id="wpsc_thankyou_url"
               value="<?php echo $wpsc_thankyou_url ?>"/>
    </div>

...
<h4>
    ...
    <button style="margin-left:10px;" class="btn btn-success btn-sm"
            onclick="wpsc_get_add_status();"><?php _e( '+Add New', 'supportcandy' ); ?></button>
</h4>
	...
	<?php foreach ( $statuses as $status ) :
        ...
        <li class="ui-state-default" data-id="<?php echo $status->term_id ?>">
            <div class="wpsc-flex-container"
                ...
                <div class="wpsc-sortable-edit" onclick="wpsc_get_edit_status(<?php echo $status->term_id ?>);"><i
                            class="fa fa-edit"></i></div>
                <div class="wpsc-sortable-delete" onclick="wpsc_delete_status(<?php echo $status->term_id ?>);"><i

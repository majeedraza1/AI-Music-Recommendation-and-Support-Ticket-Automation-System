...
<h4>
    ...
    <button style="margin-left:10px;" class="btn btn-success btn-sm"
            onclick="wpsc_get_add_category();"><?php _e( '+Add New', 'supportcandy' ); ?></button>
</h4>
	...
	<?php foreach ( $categories as $category ) : ?>
        <li class="ui-state-default" data-id="<?php echo $category->term_id ?>">
            <div class="wpsc-flex-container" style="background-color:#1E90FF;color:#fff;">
                ...
                <div class="wpsc-sortable-edit" onclick="wpsc_get_edit_category(<?php echo $category->term_id ?>);"><i
                            class="fa fa-edit"></i></div>
                <div class="wpsc-sortable-delete" onclick="wpsc_delete_category(<?php echo $category->term_id ?>);"><i

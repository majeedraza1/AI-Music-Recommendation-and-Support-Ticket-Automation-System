...
$wpsc_terms_and_conditions_html = isset( $_POST ) && isset( $_POST['wpsc_terms_and_conditions_html'] ) ? wp_kses_post( $_POST['wpsc_terms_and_conditions_html'] ) : '';
...
// GDPR messege
$wpsc_gdpr_html = isset( $_POST ) && isset( $_POST['wpsc_gdpr_html'] ) ? wp_kses_post( $_POST['wpsc_gdpr_html'] ) : '';

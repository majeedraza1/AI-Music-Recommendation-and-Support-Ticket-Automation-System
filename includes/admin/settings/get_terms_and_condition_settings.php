...
<form id="wpsc_terms_and_cond_settings" method="post" action="javascript:wpsc_set_terms_and_condition_settings();">
    ...
    <div class="form-group">
        ...
        <p class="help-block"><?php _e( "Enable or disable Terms and Condition ticket form.", "wpsc" ); ?></p>
    ...
    <div class="form-group">
        ...
        <p class="help-block"><?php _e( "Text to show on create ticket page.", "wpsc" ); ?></p>
        <textarea class="form-control" name="wpsc_terms_and_conditions_html"
                  id="wpsc_terms_and_conditions_html"><?php echo htmlentities( $wpsc_terms_and_conditions_html ) ?></textarea>
    </div>
    ...
    <div class="form-group">
        ...
        <p class="help-block"><?php _e( "Text to show on create ticket page.", "wpsc" ); ?></p>
        <textarea class="form-control" name="wpsc_gdpr_html"
                  id="wpsc_gdpr_html"><?php echo htmlentities( $wpsc_gdpr_html ) ?></textarea>
    </div>

    <div class="form-group">
        <label for="wpsc_personal_data_retention_period"><?php _e( 'Personal Data Retention', 'supportcandy' ); ?></label>
        <p class="help-block"><?php _e( 'Enable or disable personal data retention policy .', 'wpsc' ); ?></p>
    ...
    <div class="form-group" id="wpsc_personal_data_retention_period_div" style="display:none;">
        ...
        <p class="help-block"><?php _e( 'Set time for which personal data should br reatained.', 'wpsc' ); ?></p>
        <div class="row">
            <div class="col-sm-6" style="padding-left:0px !important;">
                <input type="number" id="wpsc_personal_data_retention_period_time" class="form-control"
                       name="wpsc_personal_data_retention_period_time"
                       value="<?php echo $wpsc_personal_data_retention_period_time ?>"/>
            </div>

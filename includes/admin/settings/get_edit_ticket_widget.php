...
<form id="wpsc_frm_general_settings" method="post">
    ...
    <button type="submit" class="btn btn-success"
            onclick="javascript:wpsc_set_edit_ticket_widget(<?php echo $ticket_widget_id ?>,event);"><?php _e( 'Save Changes', 'supportcandy' ); ?></button>
    <button type="cancel" class="btn btn-default"
            onclick="javascript:wpsc_get_ticket_widget_settings()"><?php _e( 'Cancel', 'supportcandy' ); ?></button>

...
<form id="wpsc_frm_general_settings" method="post" action="javascript:wpsc_set_general_settings();">
    ...
    <div class="form-group">
		...
		?>
        <i>
            <small><a href="<?php echo htmlentities( $support_page_url ) ?>"
                      target="_blank"><?php _e( 'Click here to go to support page', 'supportcandy' ) ?></a></small>
        </i>
    </div>
    ...
    <div class="form-group">
        ...
        <p class="help-block"><?php _e( "Status to apply if 'Close Ticket' button clicked for a ticket.", "wpsc" ); ?></p>
    ...
    <div class="form-group">
        ...
        <p class="help-block"><?php _e( "Enables 'Close Ticket' button for customer inside open ticket screen.", "wpsc" ); ?></p>
    ...
    <div class="form-group">
        ...
        <p class="help-block"><?php _e( "Reply form position in open ticket page. 'Top' will load reply form above ticket threads and ticket threads will load in decending order. Whereas, 'Bottom' will load reply form below ticket thread and threads loaded in acending order.", "wpsc" ); ?></p>
    ...
    <div class="form-group">
        ...
        <p class="help-block"><?php _e( "This format will be applicable for input date fields (datepicker) for SupportCandy.", "wpsc" ); ?></p>
    ...
    <div class="form-group">
        ...
        <p class="help-block"><?php _e( "Enables guest ticket facility. Guest will able to create ticket without needing them to have an user account on website. They can create ticket using their name and email address.", "wpsc" ); ?></p>
    ...
    <div class="form-group">
        <label for="wpsc_reply_to_close_ticket"><?php _e( 'Reply to Closed Tickets', 'supportcandy' ); ?></label>
        <p class="help-block"><?php _e( "Applicable for customer only.", "wpsc" ); ?></p>
        <select class="form-control" name="wpsc_reply_to_close_ticket" id="wpsc_reply_to_close_ticket">
			<?php
			$wpsc_reply_to_close_ticket = get_option( 'wpsc_reply_to_close_ticket' );
			$selected                   = $wpsc_reply_to_close_ticket == '1' ? 'selected="selected"' : '';
			echo '<option ' . $selected . ' value="1">' . __( 'Allowed', 'supportcandy' ) . '</option>';
			$selected = $wpsc_reply_to_close_ticket == '0' ? 'selected="selected"' : '';
			echo '<option ' . $selected . ' value="0">' . __( 'Not Allowed', 'supportcandy' ) . '</option>';
			?>
        </select>
    </div>
    ...
    <div class="form-group">
        ...
        <div id="custom_login" style="display:none;">
            ...
            <input type="text" class="form-control" style="width:500px; margin-top:8px;" name="wpsc_custom_login_url"
                   value="<?php echo get_option( 'wpsc_custom_login_url' ); ?>"><br>
        </div>
    ...
    <div class="form-group">
        ...
        <div id="custom_registration" style="display:none;">
            <label style="margin-top:10px"><?php _e( 'Custom Url', 'supportcandy' ); ?></label>
            <input type="text" class="form-control" style="width:500px; margin-top:8px;"
                   name="wpsc_custom_registration_url"
                   value="<?php echo get_option( 'wpsc_custom_registration_url' ); ?>"><br>
        </div>

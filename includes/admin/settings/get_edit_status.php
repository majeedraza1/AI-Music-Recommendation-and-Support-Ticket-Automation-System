...
?>
    ...
    <div class="form-group">
        ...
        <input id="wpsc_status_bg_color" class="wpsc_color_picker" name="wpsc_status_bg_color"
...
?>
    ...
    <button type="button" class="btn wpsc_popup_action"
            onclick="wpsc_set_edit_status(<?php echo htmlentities( $status_id ) ?>);"><?php _e( 'Submit', 'supportcandy' ); ?></button>
<?php
$footer = ob_get_clean();
